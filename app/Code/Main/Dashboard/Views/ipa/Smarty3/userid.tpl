...
<table style="width: 100%; height: 100%; border-spacing: 1px;">
    ...
    <tr>
        <td colspan="3" align="center" valign="middle">
            <form name="config-userid-form" id="config-userid-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    Enter the field of the event to store the User information<br /><br />
                    Field <input class='paradigm-config-form-field' type="text" name="field" id="config_userid_{$data.id}" value="{if (isset($data.field))}{$data.field}{/if}" /><br /><br >
...
<script type="text/javascript">
    ...
    Form.intercept($('#config-userid-form-{$data.id}').get(),'{$data.id}','/paradigm/element/update',"{$windowId}");
</script>

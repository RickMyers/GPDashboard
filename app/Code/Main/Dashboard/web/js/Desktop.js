  ...
  /*      if (virtualWindows.application.user)	{
    ...
    templates: {
        ...
        window: '<div class="paradigm-desktop-window-frame" id="&&w_id&&-frame" desktop_id="&&w_id&&" >'+
                ...
                '<img desktop_id="&&w_id&&" style="position: relative; height: 20px; width: 16px; margin-right: 8px; cursor: pointer;  display: none" id="&&w_id&&-lockscroll" onclick="Desktop.sync.toggle(this); return false" class="paradigm-window-minimize" src="/images/dashboard/locked.png" alt="Lock Scroll" title="Lock window scroll" />'+
                '<img desktop_id="&&w_id&&" style="position: relative; height: 20px; width: 16px; margin-right: 8px; cursor: pointer;" id="&&w_id&&-unlockscroll" onclick="Desktop.sync.toggle(this); return false" class="paradigm-window-minimize" src="/images/dashboard/unlocked.png" alt="Release Scroll Lock" title="Unlock window scroll" />'+
    ...
    render: function () {
        ...
        $E('container-desktop').innerHTML += Desktop.icon.HTML;
        Desktop.icon.list = [];

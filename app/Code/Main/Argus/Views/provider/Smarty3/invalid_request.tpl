                    ...
                    <tr>
                        <td>
                            <div style='width: 500px; border: 1px solid #777; border-radius: 20px; padding: 20px; margin-left: auto; margin-right: auto' id="registration-form-layer">
                                <b>ATTENTION</b>:<br /><br />
                                The Form ID that was entered is invalid (for some reason).<br /><br />
                                Please check the link in the E-mail that was sent to you, and click that again... <br /><br />
                                Or click the following link to make a new request:  <a href="/argus/provider/register">New Request</a><br /><br />
                            </div>
                        </td>
                    </tr>
                </table>

        ...
        <td colspan="3" align="center" valign="middle">
            ...
            <form name="config-batch-claims-form" id="config-batch-claims-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    This stage will find all claims that aren't claimed or denied and batch them up for another round of reconciliation.<br /><br />
                    Please specify below the name of the field on the event to attach the batched claims to:<br /><br />
                    Field Name: <input class='paradigm-config-form-field' type="text" name="field" id="field_{$data.id}" value="{if (isset($data.field))}{$data.field}{/if}" /><br /><br >

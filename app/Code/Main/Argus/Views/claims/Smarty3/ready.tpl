        ...
        <td colspan="3" align="center" valign="middle">
            ...
            <form name="config-batch-claims-form" id="config-batch-claims-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    This stage will check to see if there are claims that need reconciled from the previous stage, and forward the process on to the reconciliation stage if there are.<br /><br />
                    Please specify below the name of the field on the event that has the claims attached to evaluate:<br /><br />

        ...
        <td colspan="3" align="center" valign="middle">
            <form name="config-coverage-form" id="config-coverage-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    ...
                    what the name of the field is on the application that contains whether there is a rider or not.<br /><br />
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>Rider Field </td>
                            <td><input class='paradigm-config-form-field' type="text" name="rider_field" id="config_rider_{$data.id}" value="{if (isset($data.rider_field))}{$data.rider_field}{/if}" /></td>
                        </tr>
                    </table>
                    <br /><br >

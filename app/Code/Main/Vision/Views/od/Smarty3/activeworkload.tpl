...
<!--
    ...
    on the 'active-workloads-' placeholder with a unique name for the form element you are configuring.
...
<!-- ################################ END HEADER SECTION ########################################-->    
    <tr>
        <td colspan="3" align="center" valign="middle">
            <!-- ########################## FORM SECTION ########################################-->
            <form name="config-active-workloads-form" id="config-active-workloads-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    This form lets you name the field on the event that contains the OD workload information.<br /><br />
...
<script type="text/javascript">
    ...
    Form.intercept($('#config-active-workloads-form-{$data.id}').get(),'{$data.id}','/paradigm/element/update',"{$windowId}");
</script>

...
<style type="text/css">
    label {
        border: 0px; padding: 0px; margin: 0px; position: relative
    }
    .block {
    ...
    .diagnosis_codes_cell {
        overflow: hidden; user-select: true; white-space: nowrap; vertical-align: top; border-spacing: 0px
    }
...
<div id="checkmodal" class="modaltwo" style="display:none">
    <div class="modaltwo-contenttwo">
        ...
        <input tabindex="1" type="button" class="" style="" value="  NO  " onclick="closer('N')" />
        <input tabindex="1" type="button" class="" style="" value="  YES  " onclick="closer('Y')" />
        <br />
    </div>
</div>
            ...
            <td style='background-color: rgba(77,77,77,.3)'>
                <div style='width: 500px; padding: 10px; border-radius: 10px; border: 1px solid #aaf; background-color: ghostwhite; margin-left: auto; margin-right: auto'>
                    <form name='comment-attach-form' id='comment-attach-form' onsubmit='return false'>
                        <input type="hidden" name="form_comment_id" id="form_comment_id" value="" />
                        <fieldset style='padding: 10px'>
                            ...
                            <input tabindex="1" type='button' value='Attach' style='float: right' id='comment_attach_button' onclick='this.style.visibility="hidden"; Argus.vision.comment.post("{$form_id}","{$window_id}")' />
                            <input tabindex="1" type='button' value='Cancel' onclick="$('#form-comment-layer').css('display','none')" />
                        </fieldset>
                    </form>
                </div>
            </td>
    ...
    <div id="vision-form-images-tab">
                        ...
                        <div style='width: 500px; padding: 10px; border-radius: 10px; border: 1px solid #aaf; background-color: ghostwhite; margin-left: auto; margin-right: auto'>
                            <form name='vision-attach-scan-form' id='vision-attach-scan-form' onsubmit='return false'>
                                <fieldset style='padding: 10px'>
                                    ...
                                    <input tabindex="1" type='file' multiple="true" name='form-scan-image' id='form-scan-image' style='background-color: lightcyan; padding: 3px; border: 1px solid #aaf; border-radius: 3px; width: 300px' placeholder='Scanned Image' /><br /><br />
                                    <div id="upload-controls}">
                                        <input tabindex="1" type='button' value='Attach' style='float: right' onclick='Argus.vision.scan.attach("{$form_id}","{$window_id}")' />
                                        <input tabindex="1" type='button' value='Cancel' onclick="$('#scan_upload_layer').css('display','none')" />
                                    </div>
        ...
        <div>
            ...
            <div style='margin-top: 10px; padding-left: 10px'>
                <input tabindex="1" type='button' id='add_scan_button' value='Add Scan' />
            </div>        
        </div>                            
    </div>
    {/if}
...
<div id="vision-form-tab" style="position: relative;">
    <form name="new-retina-consultation-form" id="new-retina-consultation-form" onsubmit="return false">
        ...
        <input type="hidden" name="private_note"        id="private_note" value="" />
            ...
            <div style="width: 100%; border-right: 2px; border-right-color: #999;">
                        ...
                        <div class="form-cell" style="width: 10%">
                            ...
                            <div class="form-cell-field ">
                                <div class="form_input">
                                    <input tabindex="1" type="text" class="form-field" style="font-weight: bold;" name="event_id" id="event_id"  />
                                </div>
                                <div class="form_text">
                                    {if isset($data.event_id)}{$data.event_id}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                ...
                                <div id="screening_client_text" class='form_text' style="display: none">
                                    {if (isset($data.screening_client))}{$data.screening_client}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="ipa_box_select" class='form_input' style="display: none">
                                    ...
                                    </select><input tabindex="1" type="text" name="ipa_id_combo" id="ipa_id_combo" />
                                </div>
                                <div id="ipa_box_text" class='form_text' style="display: none">
                                    {if (isset($data.ipa_id_combo))}{$data.ipa_id_combo}{else}&nbsp;{/if}
                                </div>                                
                            </div>
                        </div><div class="form-cell" style="width: 23%">
                            <div class="form-cell-header" style="">
                            ...
                            <div class="form-cell-field ">
                                <div id="location_id_input" class='form_input' style="display: none">
                                   <select class="form-field" style="" name="location_id" id="location_id">
                                        <option value=""></option>
                                    </select><input tabindex="1" type="text" name="location_id_combo" id="location_id_combo" />                                    
                                </div>
                                <div id="location_id_text" class='form_text' style="display: none">
                                    {if (isset($data.location_id_combo))}{$data.location_id_combo}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div><div class="form-cell" style="width: 22%">
                            <div class="form-cell-header" style="">
                            ...
                            <div class="form-cell-field ">
                                <div id="form_type_text" style="white-space: nowrap">
                                <img id="private_note_icon" src="/images/vision/leave_note.png" style="height: 22px; float: left; margin-right: 5px;  cursor: pointer; display: none" onclick="Argus.vision.consultation.note.leave()" title="Leave private note"/>                                     
                                    {if (isset($data.form_type))}{$data.form_type|strtoupper}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div>                            
                    </div>  
                    <div class="form-row"><div class="form-cell" style="width: 55%">
                            <div class="form-cell-header" style="">
                                Event Location:
                            </div>
                            <div class="form-cell-field ">
                                <div id="address_id_input" class='form_input' style="display: none">
                                    ...
                                    <input tabindex="1" placeholder="Address Street, City, State, Zip" type="text" class="form-field pcp_staff" name="address_id_combo" id="address_id_combo" />
                                </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="npi_id_input" class='form_input' style="display: none">
                                    ...
                                    <input tabindex="1" type="text" class="form-field pcp_staff" name="npi_id_combo" id="npi_id_combo" />
                                </div>
                                <div id="npi_id_text" class='form_text' style="display: none">
                                    {if (isset($data.npi_id_combo))}{$data.npi_id_combo}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="event_date_input" class='form_input' style="display: none">
                                    <input tabindex="1" placeholder="MM/DD/YYYY" type="text" class="form-field pcp_staff" name="event_date" id="event_date" />
                                </div>
                                <div id="event_date_text" class='form_text' style="display: none">
                                    {if (isset($data.event_date))}{$data.event_date|date_format:"m/d/Y"}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div>
                    </div>                                
                    <div class="form-row"><div class="form-cell" style="width: 15%">
                            <div class="form-cell-header" style="">
                                Member ID#
                            </div>
                            <div class="form-cell-field ">
                                <div id="member_id_input" class='form_input' style="display: none">
                                    <input tabindex="1" type="text" style="font-family: serif; text-transform: uppercase" class="form-field pcp_staff" name="member_id" id="member_id" />
                                </div>
                                <div id="member_id_text" class='form_text' style="display: none; font-family: serif; text-transform: uppercase; font-weight: bolder">
                                    {if (isset($data.member_id))}{$data.member_id}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="member_name_input" class='form_input' style="display: none">
                                    <input tabindex="1" type="text" placeholder="Last, First" style="font-family: serif; text-transform: uppercase" class="form-field pcp_staff" name="member_name" id="member_name" />
                                </div>
                                <div id="member_name_text" class='form_text' style="display: none; font-family: serif; text-transform: uppercase; font-weight: bolder">
                                    {if (isset($data.member_name))}{$data.member_name}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="date_of_birth_input" class='form_input' style="display: none">
                                    <input tabindex="1" type="text" class="form-field pcp_staff" style="" name="date_of_birth"    id="date_of_birth" placeholder="MM/DD/YYYY" />
                                </div>
                                <div id="date_of_birth_text" class='form_text' style="display: none">
                                    {if (isset($data.date_of_birth) && ($data.date_of_birth))}{$data.date_of_birth|date_format:'m/d/Y'}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div><div class="form-cell" style="width: 15%">
                            <div class="form-cell-header" style="">
                            ...
                            <div class="form-cell-field ">
                                ...
                                <div id="gender_text" class='form_text' style="display: none">
                                    {if (isset($data.gender))}{$data.gender}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div><div class="form-cell" style="width: 20%">    
                            <div class="form-cell-header">
                        ...
                        <div class="form-cell" style="width: 35%">
                            ...
                            <div class="form-cell-field ">
                                <div id="member_address_input" class='form_input' style="display: none">
                                    <input tabindex="1" placeholder="Address Street, City, State, Zip" type="text" class="form-field pcp_staff"  name="member_address" id="member_address" />
                                </div>
                                <div id="member_address_text" class='form_text' style="display: none">
                                    {if (isset($data.member_address))}{$data.member_address}{else}&nbsp;{/if}
                                </div>
                            </div>
                            ...
                            <div class="form-cell-field ">
                                <div id="physician_npi_input" class='form_input' style="display: none">
                                    <select  class="form-field pcp_staff" style="width: 90%" name="physician_npi" id="physician_npi" ><option value=""></option></select><input tabindex="1" type="text" name="physician_npi_combo" id="physician_npi_combo" class="form-field pcp_staff"  placeholder="NPI ###" />
                                </div>
                                <div id="physician_npi_text" class='form_text' style="display: none">
                                    {if (isset($data.physician_npi_combo))}{$data.physician_npi_combo}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div><div class="form-cell" style="width: 35%">
                            <div class="form-cell-header" style="padding-left: 1px">
                            ...
                            <div class="form-cell-field ">
                                <div id="primary_doctor_input" class='form_input' style="display: none">
                                    Dr. <select style="width: 90%" class="form-field pcp_staff"  name="primary_doctor" id="primary_doctor" ><option value=""> </option></select><input tabindex="1" type="text" name="primary_doctor_combo" id="primary_doctor_combo" class="form-field pcp_staff" placeholder="Last, First" />
                                </div>
                                <div id="primary_doctor_text" class='form_text' style="display: none">
                                    {if (isset($data.primary_doctor_combo))}Dr. {$data.primary_doctor_combo}{else}&nbsp;{/if}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="field-block" style="white-space: nowrap; overflow: hidden; float: right">
                    <div class="" style="float: right; margin-left: 10px; width: 200px; border-bottom: 1px solid #333" id="technician_signature">
                        &nbsp; <input tabindex="1" type="button" value=" Preparer Sign " style="display: none;float: right; font-size: 1em;" id="preparer_sign_button" name="preparer_sign_button" />
                    </div>
                ...
                <div class="block" style="padding-left: 10px; font-size: 1.1em; color: black;">
                    <input tabindex="1" type="checkbox" name="patient_agreement" id="patient_signature" value="Y" /> By checking this box, patient consents to this screening service
                </div>
                <!--/div-->
                    ...
                    <tr>
                        <td style="background-color: rgba(202,202,202,.2); width: 20%">
                            <div class="field-block">
                                ...
                                <div class="block">
                                    <input tabindex="1" type="text" class="form-field pcp_staff" style="width: 65px" name="fbs" id="fbs" />
                                </div>
                            </div>
                        </td>
                        <td style="background-color: rgba(202,202,202,.2)">
                            <div class="field-block">
                                ...
                                <div class="block">
                                    <input tabindex="1" type="text" class="form-field pcp_staff" style="width: 90px" name="fbs_date" id="fbs_date" placeholder="MM/DD/YYYY" />
                                </div>
                            </div>
                        </td>
                        <td colspan="2">
                                ...
                                <tbody> 
                                    <tr>
                                        <td style="background-color: rgba(202,202,202,.2)">
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="radio" value='t1' style="" class="pcp_staff" name="type_dm" id="type_1diab" /> Type 1 DM
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td style="background-color: rgba(202,202,202,.2)">
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="radio" value='t2' style="" class="pcp_staff" name="type_dm" id="type_2diab" /> Type 2 DM
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="background-color: rgba(202,202,202,.2)">
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="radio" value="controlled" class="pcp_staff" style="" name="dm_alltype" id="dm_alltype_controlled" /> Controlled
                                                </div>
                                            </div>
                                        </td>
                                        <td style="background-color: rgba(202,202,202,.2)">
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="radio" value="uncontrolled" class="pcp_staff" style="" name="dm_alltype" id="dm_alltype_uncontrolled" /> Uncontrolled
                                                </div>
                                            </div>
                                        </td>
                                        <td style="background-color: rgba(202,202,202,.2)">
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="radio" value="unknown" class="pcp_staff" style="" name="dm_alltype" id="dm_alltype_unknown" /> Unknown
                                                </div>
                                            </div>
                                        </td> 
                                    </tr>
                        ...
                        <td style="background-color: rgba(202,202,202,.2)">
                            <div class="field-block">
                                ...
                                <div class="block">
                                    <input tabindex="1" type="text" class="form-field pcp_staff numberremover" style="width: 40px" name="type_yrs" id="type_yrs" /> yrs
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: rgba(202,202,202,.2); width: 20%">
                            <div class="field-block">
                                ...
                                <div class="block">
                                    <input tabindex="1" type="text" class="form-field pcp_staff" style="width: 65px" name="hba1c" id="hba1c" />%
                                </div>
                            </div>
                        </td>
                        <td style="background-color: rgba(202,202,202,.2)">
                            <div class="field-block">
                                ...
                                <div class="block">
                                    <input tabindex="1" type="text" class="form-field pcp_staff" style="width: 90px" name="hba1c_date" id="hba1c_date" placeholder="MM/DD/YYYY" />
                                </div>
                            </div>
                        </td>
                        <td colspan="3">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="checkbox" style="" class="pcp_staff block" name="type_oral" id="type_oral" /> Oral
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="checkbox" style="" class="pcp_staff" name="type_injected" id="type_injected" /> Injected
                                                </div>
                                            </div>
                                        </td>                                        
                                        <td>
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="checkbox" style="" class="pcp_staff" name="type_diet" id="type_diet" /> Diet
                                                </div>
                                            </div>
                                        </td>  
                                        <td>                                        <td>
                                            <div class="field-block">
                                                <div class="block">
                                                    <input tabindex="1" type="checkbox" style="" class="pcp_staff" name="type_insulin" id="type_insulin" /> Insulin
                                                </div>
                                            </div>
                                        </td>   
                                    </tr>
                        ...
                        <td>
                            <div class="field-block">
                                <div class="block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" type="text" class="form-field pcp_staff " style="width: 65px; " name="bmi" id="bmi" />
                                    </div>
                                </div>
                            </div>
                        </td>
                ...
                <div id="highlight_block_2">
                    <table style="width: 100%">
                        <tr>
                            <td style="background-color: rgba(202,202,202,.2); width: 15%">
                                <div class="field-block">
                                    <div class="block">
                                        DV s <input tabindex="1" type="radio" value="s"  name="sorc" id="sorc_s" class="doctor_field" />  /c <input tabindex="1" type="radio" value="c"  name="sorc" id="sorc_c" class="doctor_field" /> Rx:
                                    </div>
                                </div>
                            </td>
                            <td style="background-color: rgba(202,202,202,.2); width: 20%">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        ...
                                        <div style="display: inline-block; position: relative">
                                            ...
                                            <input tabindex="1" type="text" name="dv_od_combo" id="dv_od_combo" class="form-field doctor_field" />
                                ...
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        ...
                                        <div style="display: inline-block; position: relative">
                                            ...
                                            <input tabindex="1" type="text" class="form-field doctor_field" name="dv_os_combo" id="dv_os_combo" />
                            ...
                            <td style="background-color: rgba(202,202,202,.2)">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" type="text" class="form-field" style="width: 90px" name="last_exam_date" id="last_exam_date" placeholder="MM/DD/YYYY" />
                        ...
                        <tr>
                            ...
                            <td style="background-color: rgba(202,202,202,.2); width: 20%">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" type="text" name="iop_od" id="iop_od"  style="width: 60px" class="form-field doctor_field">
                                        mmHg
                                    </div>
                                </div>
                            </td>
                            <td style="background-color: rgba(202,202,202,.2)">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" type="text" name="iop_os" id="iop_os"  style="width: 60px" class="form-field doctor_field">
                                        mmHg
                                    </div>
                                </div>
                            </td>
                            <td style="background-color: rgba(202,202,202,.2)">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" type="text" class="form-field doctor_field" style="width: 80px" name="exam_time" id="exam_time" />
                        ...
                        <tr>
                            ...
                            <td style="background-color: rgba(202,202,202,.2); width: 42%">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="od_pupil" id="od_pupil_none" value="0" checked='true' style='visibility: hidden' />
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="od_pupil" id="od_pupil_1" value="1" /> 1 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="od_pupil" id="od_pupil_2" value="2" /> 2 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="od_pupil" id="od_pupil_3" value="3" /> 3 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="od_pupil" id="od_pupil_4" value="4"/> 4 &nbsp;
                            ...
                            <td style="background-color: rgba(202,202,202,.2)">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="os_pupil" id="os_pupil_none" value="0" checked='true' style='visibility: hidden' />
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="os_pupil" id="os_pupil_1" value="1" /> 1 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="os_pupil" id="os_pupil_2" value="2"/> 2 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="os_pupil" id="os_pupil_3" value="3"/> 3 &nbsp;
                                        <input tabindex="1" class="doctor_field deselecter" type="radio" name="os_pupil" id="os_pupil_4" value="4"/> 4 &nbsp;
                    ...
                    <table style="width: 100%; margin-top: 2px">
                        <tr>
                            ...
                            <td style="background-color: rgba(202,202,202,.2);">
                                <div class="field-block">
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type='checkbox' name='dilation_none' id='dilation_none' value='Y'/> None&nbsp;&nbsp;
                                        <input tabindex="1" class="doctor_field" type='checkbox' name='dilation_fivem' id='dilation_fivem' value='Y'/> 0.5% M&nbsp;&nbsp;
                                        <input tabindex="1" class="doctor_field" type='checkbox' name='dilation_onem' id='dilation_onem' value='Y'/> 1.0% M&nbsp;&nbsp;
                                        <input tabindex="1" class="doctor_field" type='checkbox' name='dilation_twentyfiven' id='dilation_twentyfiven' value='Y'/> 2.5% N&nbsp;&nbsp;
                                        <input tabindex="1" class="doctor_field" type='checkbox' name='dilation_paremyd' id='dilation_paremyd' value='Y'/> Paremyd
                                    </div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%; margin-top: 2px">
                        <tr>
                            ...
                            <td style="background-color: rgba(202,202,202,.2);">
                                <div class="field-block">
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type='radio' name='retinopathy' id='retinopath_no' value='No DR' /> No diabetic retinopathy
                                    </div>
                                </div>
                            </td>
                            <td style="background-color: rgba(202,202,202,.2);">
                                <div class="field-block">
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type='radio' name='retinopathy' id='retinopath_background' value='Background' /> Background diabetic retinopathy
                                    </div>
                                </div>
                            </td>
                            <td style="background-color: rgba(202,202,202,.2);">
                                <div class="field-block">
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type='radio' name='retinopathy' id='retinopath_proliferative' value='Proliferative' /> Proliferative diabetic retinopathy
                                    </div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table style='width: 100%; margin-bottom: 15px'>
                        <tr>
                            ...
                            <td width='84%'>
                                <input tabindex="1" type="text" class="form-field doctor_field" style="width: 100%" name="exam_finding" id="exam_finding" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <table style='width: 100%'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field nodx" type='checkbox' name='diag_code_e11_9' id='diag_code_e11_9' value='Y' style='margin-right: 10px'  /> E 11.9
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field nodx" type='checkbox' name='diag_code_e10_9' id='diag_code_e10_9' value='Y' style='margin-right: 10px' /> E 10.9
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'> DM controlled, no ocular manif.</td>
                            </tr>
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field nodx" type='checkbox' name='diag_code_e11_65' id='diag_code_e11_65' value='Y' style='margin-right: 10px' /> E 11.65
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field nodx" type='checkbox' name='diag_code_e10_65' id='diag_code_e10_65' value='Y' style='margin-right: 10px' /> E 10.65
                                </td>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e11_39' id='diag_code_e11_39' value='Y' style='margin-right: 10px' /> E 11.39
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e10_39' id='diag_code_e10_39' value='Y' style='margin-right: 10px' /> E 10.39
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td colspan='2' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='other_diabetes' id='other_diabetes' value='Y' style='margin-right: 10px' /> E 13.9
                                </td>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e11_319' id='diag_code_e11_319' value='Y' style='margin-right: 10px' /> E 11.319
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e10_319' id='diag_code_e10_319' value='Y' style='margin-right: 10px' /> E 10.319
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e11_311' id='diag_code_e11_311' value='Y' style='margin-right: 10px' /> E 11.311
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field backgrounddx" type='checkbox' name='diag_code_e10_311' id='diag_code_e10_311' value='Y' style='margin-right: 10px' /> E 10.311
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                                    Unspecified DR, w/ ME 
                                </td>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_321' id='diag_code_e11_321' value='Y' style='margin-right: 10px' />  <label  id='lbl_code_e11_321' for='diag_code_e11_321'>E 11.321_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_321' id='diag_code_e10_321' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e10_321' for='diag_code_e10_321'>E 10.321_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_329' id='diag_code_e11_329' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_329' for='diag_code_e11_329'>E 11.329_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_329' id='diag_code_e10_329' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e10_329' for='diag_code_e10_329'>E 10.329_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_331' id='diag_code_e11_331' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_331' for='diag_code_e11_331'>E 11.331_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_331' id='diag_code_e10_331' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e10_331' for='diag_code_e10_331'>E 10.331_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_339' id='diag_code_e11_339' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_339' for='diag_code_e11_339'>E 11.339_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_339' id='diag_code_e10_339' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e10_339' for='diag_code_e10_339'>E 10.339_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_341' id='diag_code_e11_341' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_341' for='diag_code_e11_341'>E 11.341_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_341' id='diag_code_e10_341' value='Y' style='margin-right: 10px' />  <label  id='lbl_code_e10_341' for='diag_code_e10_341'>E 10.341_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_349' id='diag_code_e11_349' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_349' for='diag_code_e11_349'>E 11.349_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_349' id='diag_code_e10_349' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e10_349' for='diag_code_e10_349'>E 10.349_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_351' id='diag_code_e11_351' value='Y' style='margin-right: 10px' />  <label  id='lbl_code_e11_351' for='diag_code_e11_351'>E 11.351_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_351' id='diag_code_e10_351' value='Y' style='margin-right: 10px' />  <label  id='lbl_code_e10_351' for='diag_code_e10_351'>E 10.351_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                            ...
                            <tr>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e11_359' id='diag_code_e11_359' value='Y' style='margin-right: 10px' /> <label  id='lbl_code_e11_359' for='diag_code_e11_359'>E 11.359_</label>
                                </td>
                                <td width='10%' class='diagnosis_codes_cell'>
                                    <input tabindex="1" class="doctor_field cdbs" type='checkbox' name='diag_code_e10_359' id='diag_code_e10_359' value='Y' style='margin-right: 10px' />  <label  id='lbl_code_e10_359' for='diag_code_e10_359'>E 10.359_</label>
                                </td>
                                <td width='30%' class='diagnosis_codes_cell'>
                    ...
                    <div style="width: 49.5%; display: inline-block;" onchange="">
                        ...
                        <div style="border: 1px solid #bbb; margin-top: 6px">
                            ...
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_s3000' id='pc_s3000' value='Y' style='margin-right: 10px' /> S3000
                            </div>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_2022f' id='pc_2022f' value='Y' style='margin-right: 10px' />
                                2022F
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>                            
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_2023f' id='pc_2023f' value='Y' style='margin-right: 10px' />
                                2023F
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                        ...
                        <div style="border: 1px solid #bbb; margin-top: 12px">
                            ...
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_92227' id='pc_92227' value='Y' style='margin-right: 10px' />
                               92227
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_2033f' id='pc_2033f' value='Y' style='margin-right: 10px' />
                               2033F
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_92228' id='pc_92228' value='Y' style='margin-right: 10px' />
                               92228
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_2026f' id='pc_2026f' value='Y' style='margin-right: 10px' />
                               2026F
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; '>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='images_unreadable' id='images_unreadable' value='Y' style='margin-right: 10px' />
                        ...
                        <div id="recommendations" >                        
                            ...
                            <div style='display: inline-block; margin-right: 2px; width: 60%'>
                                 <input tabindex="1" class="doctor_field" type='checkbox' name='eye_exam' id='eye_exam' value='Y' style='margin-right: 10px' />
                                 Comprehensive Eye Exam
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                                <input tabindex="1" type='text' name='eye_exam_period_quantity' id='eye_exam_period_quantity' class='form-field doctor_field referral_field ' style='width: 50px; text-align: center' />
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 60%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='opth_referral' id='opth_referral' value='Y' style='margin-right: 10px' />
                                Referral to Ophthalmologist
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                                <input tabindex="1" type='text' name='opth_referral_period_quantity' id='opth_referral_period_quantity' class='form-field doctor_field referral_field' style='width: 50px; text-align: center' />
                            ...
                            <div style="clear: both"></div>    
                            <div style='display: inline-block; margin-right: 2px; width: 60%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='retinal_referral' id='retinal_referral' value='Y' style='margin-right: 10px' />
                                Referral to Retinal Specialist
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                                <input tabindex="1" type='text' name='retinal_referral_period_quantity' id='retinal_referral_period_quantity' class='form-field doctor_field  referral_field' style='width: 50px; text-align: center' />
                    ...
                    <div style='position: relative; margin-top: 10px'>
                        <div id="comment_area" style='overflow-y: auto; overflow-x: hidden; width: 99%; margin-bottom: 2px; padding: 5px; height: 142px; background-color: lightcyan; border: 1px solid #333'>
{foreach from=$comments->setFormId($form_id)->fetch() item=comment}
    <div style="background-color: rgba(220,220,220,{cycle values=".2,.4"}); border-bottom: 1px solid #bbb; clear: both"
        ><div style="float: left; border-right: 1px solid #bbb; margin-right: 2px; min-width: 125px">
          {if ($comment.user_id == $current_user) && (!$print)}
...
{/foreach}                        
                        ...
                        <div style='position: absolute; top: -12px; left: 4px; font-size: 1.3em; font-weight: bolder'>Notes:</div>
                    </div>
                    <div style="background-color: rgba(202,202,202,.3); position: relative">
                       ...
                       <div id="form_admin_panel" style="display: none;  border: 2px solid silver; height: 16px; overflow: visible; position: relative; border-top-right-radius: 8px; border-bottom-right-radius: 8px; background-color: bisque; text-align: right; padding-left: 40px">
                        ...
                        <input tabindex="1" id="submit_for_review_button" type="button" value="  Submit For O.D. Review  " style="display: none"/>
                             ...
                             <div id="unscannable_option" style="float: left; padding: 5px 2px; display: none">
                                <input tabindex="1" type="checkbox" id="member_unscannable" name="member_unscannable" value='Y' /> <span style="color: red; font-weight: bold">Unable To Scan Member</span>
                            </div>
                       
                           
                            <input tabindex="1" id="return_to_submitter_button" type="button" value="  Return To Submitter  " style="display: none; float: left"/>
                ...
                <div style="width: 600px; margin-left: auto; margin-right: auto">
                    <fieldset><legend>Feedback Form</legend>
                        <div style="display: inline-block; width: 48%;">
                            ...
                            <input tabindex="1" type="radio" class="doctor_field" name="image_quality" id="image_quality_5" value="5" /> Very Good<br />
                            <input tabindex="1" type="radio" class="doctor_field" name="image_quality" id="image_quality_4" value="4" /> Good<br />
                            <input tabindex="1" type="radio" class="doctor_field" name="image_quality" id="image_quality_3" value="3" /> Fair<br />
                            <input tabindex="1" type="radio" class="doctor_field" name="image_quality" id="image_quality_2" value="2" /> Poor<br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="too_dark" id="too_dark" value="Y" /> Too Dark<br />
                        </div>                
                        <div style="display: inline-block; width: 48%">
                            <u>Submitted Without:</u><br /><br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="missing_a1c"            id="missing_a1c"           value="Y" /> Hemoglobin A1C Value<br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="missing_diabetes_type"  id="missing_diabetes_type" value="Y" /> Diabetes Type (1 or 2)<br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="missing_pcp_npi"        id="missing_pcp_npi"       value="Y" /> PCP NPI #<br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="missing_event_location" id="missing_event_location" value="Y" /> Event Location<br />
                            <input tabindex="1" type="checkbox" class="doctor_field" name="no_readable_images"     id="no_readable_images"    value="Y" /> Readable Images For Both Eyes*<br />
                        </div>
                        <div style="padding: 20px">
                            * Need readable images for both eyes or a note stating patient is monocular in order to complete record.                    
                        </div>
                        Additional Comments<br />
                        <textarea class="doctor_field"
                                  name="additional_comments"
                                  id="additional_comments"
                                  style="background-color: lightcyan; width: 90%; height: 100px; color: #333; border: 1px solid #aaf; padding: 3px" placeholder="Comments..."></textarea>
                    </fieldset>
                </div>
        </form>
    </div>

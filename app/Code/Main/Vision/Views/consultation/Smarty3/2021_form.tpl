                ...
                <div style='width: 500px; padding: 10px; border-radius: 10px; border: 1px solid #aaf; background-color: ghostwhite; margin-left: auto; margin-right: auto'>
                    <form name='comment-attach-form' id='comment-attach-form' onsubmit='return false'>
                        ...
                        <fieldset style='padding: 10px'>
                            ...
                            <input tabindex="1" type='button' value='Attach' style='float: right' id='comment_attach_button' onclick='this.style.visibility="hidden"; Argus.vision.comment.oldpost("{$form_id}","{$window_id}")' />
                        ...
                        <div class="form-cell" style="width: 10%">
                            ...
                            <div class="form-cell-field ">
                                ...
                                <img id="private_note_icon" src="/images/vision/leave_note.png" style="height: 22px; float: left; margin-right: 5px;  cursor: pointer; display: none" onclick="Argus.vision.consultation.note.leave()" title="Leave private note"/>                                     
                                    {if (isset($data.form_type))}{$data.form_type|strtoupper}{else}N/A{/if}
                                </div>
                            </div>
                        </div>                            
                    </div>                            
                ...
                <div id="highlight_block_2">
                        ...
                        <tr>
                            ...
                            <td style="background-color: rgba(202,202,202,.2); width: 42%">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type="radio" name="od_pupil" id="od_pupil_none" value="0" checked='true' style='visibility: hidden' />
                                        <input tabindex="1" class="doctor_field" type="radio" name="od_pupil" id="od_pupil_1" value="1" /> 1 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="od_pupil" id="od_pupil_2" value="2" /> 2 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="od_pupil" id="od_pupil_3" value="3" /> 3 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="od_pupil" id="od_pupil_4" value="4"/> 4 &nbsp;
                            ...
                            <td style="background-color: rgba(202,202,202,.2)">
                                <div class="field-block">
                                    ...
                                    <div class="block">
                                        <input tabindex="1" class="doctor_field" type="radio" name="os_pupil" id="os_pupil_none" value="0" checked='true' style='visibility: hidden' />
                                        <input tabindex="1" class="doctor_field" type="radio" name="os_pupil" id="os_pupil_1" value="1" /> 1 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="os_pupil" id="os_pupil_2" value="2"/> 2 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="os_pupil" id="os_pupil_3" value="3"/> 3 &nbsp;
                                        <input tabindex="1" class="doctor_field" type="radio" name="os_pupil" id="os_pupil_4" value="4"/> 4 &nbsp;
                    ...
                    <div style="width: 49.5%; display: inline-block;" onchange="">
                        ...
                        <div style="border: 1px solid #bbb; margin-top: 6px">
                            ...
                            <!--div style='display: inline-block; margin-right: 2px; width: 20% ' class="lbl3072f">
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_3072f' id='pc_3072f' value='Y' style='margin-right: 10px' />
                               3072F
                            </div>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_5010f' id='pc_5010f' value='Y' style='margin-right: 10px' />
                                5010F
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                            ...
                            <div style="clear: both"></div>
                            <div style='display: inline-block; margin-right: 2px; width: 20%'>
                                <input tabindex="1" class="doctor_field" type='checkbox' name='pc_g8397' id='pc_g8397' value='Y' style='margin-right: 10px' />
                                G8397
                            </div>
                            <div style='display: inline-block; margin-right: 2px'>
                    ...
                    <div style="background-color: rgba(202,202,202,.3); position: relative">
                       ...
                       -->
                            ...
                            <input tabindex="1" type="button" id="release_to_pcp_portal" onclick="Argus.vision.pcp.release('{$form_id}')" style="margin-left: auto; margin-right: auto; display: none;" value="  Release To PCP Portal  " />
                            
                            <input tabindex="1" type="button" id="mark_form_as_claimed_button" onclick="Argus.vision.claim.clear()" style="float: left; display: none; margin-left: 1px" value="  Mark Form Claimed  " />
                            ...
                            <input tabindex="1" type="button" id="doctor_sign_and_complete_button" class="" style="margin-left: auto; display: none; margin-right: auto" value="  Doctor Sign and Complete Form  " />
                            ...
                            <input tabindex="1" id="clear_signature_and_return_to_doctor_button" type="button" value=" Clear Signature And Return To Doctor " style="display: none"/>
                            <div style="clear: both"></div>
                    </div>                        
                    <div style="clear: both"></div>

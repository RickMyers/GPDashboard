        ...
        <div style="width: 885px; padding-left: 5px; padding-right: 5px; margin-left: 10px;  border-right-style: solid; display: inline-block">
            <div style="width: 100%; border-right: 2px; border-right-color: #999;">
                ...
                <div style="text-align: center; margin-top: 5px; border-top: 1px solid #333">
                    <div style="float: right; margin-right: 5px">(rev 03.06.17)</div>
                    <b>Aflac Benefits Solutions, Inc.</b>, 4211 West Boy Scout Blvd, Suite 295, Tampa, FL, 33607 (Toll Free 877.864.0625)
                </div>                            
            </div>
            <div style="clear: both"></div>
        </form>
...
<script type='text/javascript'>
    ...
    CurrentForm.init({if ($print)}function () { window.setTimeout(window.print,1500) }{/if});
    (function () {
        var val;

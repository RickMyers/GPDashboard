...
<h3>Package: Clients.<br />
Module: Prestige.<br />
Namespace: prestige<br />
...
<ul>
    ...
    &nbsp;&nbsp;&nbsp;app/Code/Clients/Prestige/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Clients/Prestige/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Clients/Prestige/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>

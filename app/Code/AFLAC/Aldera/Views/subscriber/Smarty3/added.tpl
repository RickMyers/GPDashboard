...
<table style="width: 100%; height: 100%; border-spacing: 1px;">
    ...
    <tr>
        <td colspan="3" align="center" valign="middle">
            <form name="config-subscriberadded-form" id="config-subscriberadded-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    <br />
                    Enter the name of the field on the event that contains the result from the subscriber add attempt<br /><br />
                    Event Field <input class='paradigm-config-form-field' type="text" name="field" id="config_subscriberadded_{$data.id}" value="{if (isset($data.field))}{$data.field}{/if}" /><br /><br >
...
<script type="text/javascript">
    ...
    Form.intercept($('#config-subscriberadded-form-{$data.id}').get(),'{$data.id}','/paradigm/element/update',"{$windowId}");
</script>
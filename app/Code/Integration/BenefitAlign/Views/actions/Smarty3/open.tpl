...
<h3>Package: Integration.<br />
Module: BenefitAlign.<br />
Namespace: align<br />
Author: &lt;Richard Myers&gt;</h3>

Welcome to the home page of your application. Some useful information is below:<br />
<ul>
    <b>Configuration</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Integration/BenefitAlign/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Integration/BenefitAlign/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Integration/BenefitAlign/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>

...
<ul>
    ...
    &nbsp;&nbsp;&nbsp;app/Code/Integration/EIS/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Integration/EIS/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Integration/EIS/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>

        ...
        <td colspan="3" align="center" valign="middle">
            <form name="config-extract-field-form" id="config-extract-field-form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    <br />
                    This is the configuration for the workflow element that retrieves member and payment data from the e-health XML application
                    and puts the relevant data into our internal data format required for our B2B intake pipeline.  Please specify the name of the
                    field on the event to attach the extracted data to<br />
                    <br />
                    Field: <input class='paradigm-config-form-field' type="text" name="field" id="extract_field_{$data.id}" value="{if (isset($data.field))}{$data.field}{/if}" /><br /><br />
